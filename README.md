...
**This is the `StorageResource`+`StorageAdapter` release** (from the
`storage/releases/v0.1.0` lineage) — not the `devel`-branch `StorageBucket`
draft, which has no GHCR release of its own yet.
